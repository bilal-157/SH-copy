...
namespace jewl
{
    public partial class BankPaymentVoucher : Form
    {
        ...
        private void BankPaymentVoucher_Load(object sender, EventArgs e)
        {
            this.ShowAllAccounts();
            this.ShowLedger();
            this.txtVoucherNo.Text = vDAL.CreateVNO("BPV");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            pv.AccountCode = cha;
            pv.Dr = 0;
            pv.Cr = Convert.ToDecimal(this.txtAmount.Text);
            pv.DDate = this.dtpDate.Value;
            pv.OrderNo = 0;
            pv.SNO = 0;
            pv.VNO = vDAL.CreateVNO("BPV");
        ...
        {
            vouch = vDAL.GetBankPaymentVoucher();
            if (vouch == null)
                return;
            else
            {
        ...
        private void dgvLedger_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            vouch1 = vDAL.GetBankPaymentVoucherForUp(st);
            ...
            this.txtAmount.Text = Math.Round(vouch1.Cr, 0).ToString();
        ...
        {
            vouch = vDAL.GetBankPaymentVoucherForUpdate(stn);
            if (vouch == null)
                return;
            else
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    //this.dgvTransection.Rows[i].Cells[2].Value = vouch[i].Cr.ToString();
