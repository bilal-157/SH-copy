...
{
    public class WokerDealingMaster
    {
        ...
        //public void AddLineItems(WorkerDealing wli)
        //{
        //    if (this.lineItems == null) lineItems = new List<WorkerDealing>();
        //    lineItems.Add(wli);
        //}
        public void AddLineItems(WorkerLineItem sli)
        {
